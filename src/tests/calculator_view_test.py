...
class TestCalculator(unittest.TestCase):
    ...
    def test_if_button_is_digit_return_entry_value_plus_button(self):
        return_value = self.calculator.handle_click("", "1")
    ...
    def test_addition_works(self):
        ...
        return_value = self.calculator.handle_click("1+2", "=")
    ...
    def test_division_works(self):
        ...
        return_value = self.calculator.handle_click("4/2", "=")
        self.assertEqual(return_value, int("2"))
    ...
    def test_divide_by_zero(self):
        ...
        return_value = self.calculator.handle_click("4/0", "=")
